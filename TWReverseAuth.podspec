Pod::Spec.new do |s|
  ...
  s.version      = "0.1.0"
  s.summary      = "OAuth for Twitter using reverse auth and ACAccount -  in case your server needs to talk to twitter as well. "
  s.description  = <<-DESC
                    Authenticate to Twitter and ACAccount with reverse auth and 
                    obtain keys that are usable from the server.
                   DESC
